...
//     , _command{ command }
{
    ...
    COORD consoleSize{ (uint16_t)columns, (uint16_t)lines };
    ...
    //     _pipeListenerThread = std::thread( &console_t::PipeListener, this );
    //
...
// void console_t::WaitForCompletion( int32_t timeout )
// {
...
// bool console_t::CreatePipes( HANDLE &consoleStdIn, HANDLE &consoleStdOut )
// {
...
// }
//
// void __cdecl console_t::PipeListener()
// {
